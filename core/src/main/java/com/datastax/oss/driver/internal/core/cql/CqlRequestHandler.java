...
public class CqlRequestHandler implements Throttled {
  ...
  protected CqlRequestHandler(
    ...
    this.handlerLogPrefix = logPrefixJoiner.join(sessionName, sessionId);
  ...
  private void sendRequest(
    ...
    if (channel == null) {
      ...
      String requestId =
          this.requestIdGenerator
              .map((g) -> g.getRequestId(finalStatement, sessionId))
              .orElse(Integer.toString(this.hashCode()));
      statement =
          this.requestIdGenerator
              .map((g) -> g.getDecoratedStatement(finalStatement, requestId))
      ...
      NodeResponseCallback nodeResponseCallback =
          new NodeResponseCallback(
              ...
              logPrefixJoiner.join(this.sessionName, requestId, currentExecutionIndex));
