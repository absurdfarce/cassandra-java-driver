 ...
 * Useful if you want to describe a call of vector types that do not differ by subtype but do
 * differ by dimension.
 */
public class SubtypeOnlyVectorType extends DefaultVectorType {
    ...
    public SubtypeOnlyVectorType(DataType subtype) { super(subtype, NO_DIMENSION); }

    @Override
    public int getDimensions() {
        throw new NotImplementedException("Subtype-only vectors do not support dimensions");
    }
